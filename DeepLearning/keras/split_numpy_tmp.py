...
if __name__ == '__main__':
    rootdir = r'D:/CodeVerification/keras/test_all/Imgs/createdImgs3/'
        ...
        if os.path.isfile(filename):
            ...
            if(len(child_img_list)==len(cut_str)): 
                for i in range(0,len(child_img_list)):
                    ...
                    child_img_list[i].save("D:/CodeVerification/keras/test_all/test_singlepress/%s_%s.jpg" % (cut_str[i],random_str(10)))
            count = count+1
            print count
