...
if __name__ == '__main__':
    rootdir = r'D:/CodeVerification/keras/testall/Imgs/createdImgs7/'
    #rootdir = r'D:/CodeVerification/split_captcha/split_captcha/createdImg/'
        ...
        if os.path.isfile(filename):
            ...
            if(len(child_img_list)==len(cut_str)): 
                for i in range(0,len(child_img_list)):
                    ...
                    child_img_list[i].save("D:/CodeVerification/keras/testall/test_singlepress/%s/%s.jpg" % (cut_str[i],random_str(10)))
            count = count+1
            print count
