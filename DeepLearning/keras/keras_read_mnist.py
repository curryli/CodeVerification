...
#生成一个model  
   ...
   # model.fit(data, label, batch_size=100, nb_epoch=10,shuffle=True,verbose=1,show_accuracy=True,validation_split=0.2)  
    ...
    model.fit(traindata, trainlabel, batch_size=50,nb_epoch=20,shuffle=True,verbose=1,show_accuracy=True,validation_data=(testdata, testlabel))
...
if __name__ == '__main__':    
    trainpath = r'trainimage/pic2/'
    #testpath = r'testimage/pic2/'
    testpath = r'trainimage/pic2/'
    ...
    np.savetxt("mnist_format.txt", traindata[0][0], fmt="%d")
